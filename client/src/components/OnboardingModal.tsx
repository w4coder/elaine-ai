...
// Steps: 0=welcome, 1=name+birthday, 2=gender, 3=responseLength, 4=tone, 5=focus, 6=proactiveness, 7=extra, 8=summary
...
export function OnboardingModal({ onComplete }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Card */}
      <div
        className="relative w-full max-w-md rounded-2xl border border-[var(--border)] shadow-2xl flex flex-col"
          ...
          {step === 0 && (
            <div className="text-center space-y-4">
              ...
              <p className="text-[var(--text-soft)] text-sm leading-relaxed">
                Answer a few quick questions so I can work exactly the way you prefer. Takes under a
                minute.
              </p>
              <button
                type="button"
            ...
            <div className="space-y-6">
              ...
              {step === 2 && (
                <div className="space-y-4">
                  <h2 className="text-lg font-semibold text-[var(--text)]">How do you identify?</h2>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {RESPONSE_LENGTH_OPTIONS.map((opt) => (
                      <Chip
                        ...
                        onClick={() =>
                          setDraft((d) => ({ ...d, responseLength: opt, responseLengthOther: "" }))
                        }
                      />
                    ))}
                    <Chip
                ...
                <div className="space-y-4">
                  ...
                  {focusOtherActive && (
                    <input
                      ...
                      onChange={(e) => setDraft((d) => ({ ...d, focusOtherText: e.target.value }))}
                      className="w-full px-3 py-2 rounded-lg border border-[var(--border)] bg-[var(--bg-soft)] text-[var(--text)] text-sm placeholder:text-[var(--text-muted)] outline-none focus:border-[var(--accent)]"
                    />
                  )}
                </div>
